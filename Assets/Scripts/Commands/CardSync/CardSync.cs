...
namespace CardsVR.Commands
{
     ...
     */
    public class CardSync : ICommandData
    {
        public static readonly byte EventID = 52;
        ...
        /*
         *      Constructor for the CardSync class.
         *      
         *      Parameters
         *      ----------
         *      cardIDs : int[]
         ...
         */
        public CardSync(int[] cardIDs, int[] piles, int[] pileIndex, CardState[] cardStates, Vector3[] positions, Quaternion[] rotations, int ownerID)
        {
        ...
        /*
         *      Reconstructs a CardSync class object from an Object array.
         ...
         *      -------
         *      output : CardSync
         *          A CardSync class object populated with data from the object
         *          array.
         */
        public static CardSync FromObjectArray(object[] data)
        {
            byte ID = (byte)data[0];
            if (ID == CardSync.EventID)
            {
                ...
                return new CardSync(CardIDs, Piles, PileIndex, States, Positions, Rotations, OwnerID);
            }
            else
            {
